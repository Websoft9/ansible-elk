...
多种原因导致无法顺利安装，请使用我们在公有云上发布的 [RabbitMQ 镜像](https://apps.websoft9.com/Elastic) 的部署方式。
...
我们会定期检查[Release版本](https://github.com/Websoft9/ansible-Elastic/releases)，更新并测试此项目，以保证用户可以顺利安装所需的RabbitMQ版本。 
